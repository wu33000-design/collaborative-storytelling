    ...
    <div className="min-h-screen bg-[#F5F1E9] px-5 py-10 text-[#1F2E2A] sm:py-14">
      <main className="mx-auto max-w-4xl">
        ...
        <header className="mt-8 rounded-3xl border border-[#D8D2C6] bg-[#FFFDF8] p-7 shadow-sm sm:p-9">
          <div className="flex items-center gap-3"><Monitor size={22} className="text-[#A64E3C]" /><span className="font-mono text-[10px] uppercase tracking-[0.16em] text-[#A06B59]">教師活動監控</span></div>
          <h1 className="mt-4 font-serif text-4xl font-semibold tracking-[-0.045em] text-[#233B35]">選擇要監控的活動</h1>
          <p className="mt-4 text-sm leading-7 text-[#68746B]">進入活動後，可一次查看所有小組的學生數、段落進度、目前 Round、目前作者與最後活動時間。</p>
        </header>
